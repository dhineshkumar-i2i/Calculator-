...
(function () {
  ...
  document.querySelector("#plus").addEventListener("click", read);
  document.querySelector("#minus").addEventListener("click", read);
  document.querySelector("#multiply").addEventListener("click", read);
  document.querySelector("#divide").addEventListener("click", read);
  document.querySelector("#negate").addEventListener("click", read);
  document.querySelector("#modulo").addEventListener("click", read);
...
function calculate() {
  ...
  console.log(result);
  output.textContent = result.toString().includes(".")
    ? result.toFixed(2)
    : result;
}
